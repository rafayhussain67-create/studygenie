export default async function handler(req, res) {
  ...
  if (paperInfo && !image) {
    ...
    const baseUrl = 'https://pastpapers.papacambridge.com/papers/caie/';

    const html = '<h3>📋 Past Paper Found</h3>' +
      '<div class="step-block"><div class="step-label">Paper Details</div>' +
      'Syllabus: <strong>' + syllabus + '</strong> · Session: <strong>' + sessionName + '</strong> · Paper: <strong>' + paper + '</strong></div>' +
      '<div class="step-block"><div class="step-label">Download Links</div>' +
      '<a href="' + baseUrl + filename + '" target="_blank" rel="noopener" style="color:#1a9e6e;font-weight:700">📄 Question Paper (' + filename + ')</a><br><br>' +
      '<a href="' + baseUrl + msFilename + '" target="_blank" rel="noopener" style="color:#1a9e6e;font-weight:700">✅ Mark Scheme (' + msFilename + ')</a></div>' +
      '<div class="step-block"><div class="step-label">Can't find it?</div>' +
      '<a href="https://pastpapers.papacambridge.com/" target="_blank" rel="noopener" style="color:#1a9e6e">Search on PapaCambridge →</a> or ' +
      '<a href="https://www.ilmkidunya.com/papers/" target="_blank" rel="noopener" style="color:#1a9e6e">ilmkidunya (Pakistani boards) →</a></div>' +
      '<p>Once you have the paper, upload it using the 📷 button and I will solve the questions for you!</p>';
